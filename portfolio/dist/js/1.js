...
$(function () {
    ...
    let text = `
        <div class="quize__x__screen__first">
            ...
            <div class="start__screen__btns">
                ...
                <a href='tg://openurl?url=index.html' target="main_frame" class='btn__default btn__black quize__x__item__variant'>Назад на главную</a>
            </div>
        </div>`;
    $(".js__quize__1").html(text);
  }
  ...
  function showTotalScreen() {
    ...
    if (countCorrectAnswer <= 5) {
      yetBtn = `<a href='tg://openurl?url=1.html' target="main_frame" class='btn__default btn__blue__filled quize__x__item__variant'>Пройти ещё раз</a>`;
    }
